...
const StudentDashboard: React.FC<StudentDashboardProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700">
      ...
      <section>
        <h3 className="text-xs font-semibold text-stone-400 uppercase tracking-[0.2em] mb-6 px-2">Institutional Services</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {quickActions.map((action, i) => (
            ...
            >
              ...
              <h4 className="text-lg font-semibold text-stone-900 mb-2">{action.label}</h4>
              <p className="text-xs text-stone-500 leading-relaxed font-medium">{action.desc}</p>
              <div className="mt-6 flex items-center gap-2 text-[#5D4037] text-[10px] font-semibold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all transform translate-y-2 group-hover:translate-y-0">
                Launch Module
