...
const ProfileSettings: React.FC<ProfileSettingsProps> = ({ role, section = 'profile' }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      <header className="flex flex-col md:flex-row md:items-center md:justify-center gap-6 text-center md:text-left">
